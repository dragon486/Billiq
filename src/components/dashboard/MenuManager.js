        ...
        <div style={{ flex: 1, position: "relative" }}>
          ...
          <input 
            ...
            style={{ 
              ...
              border: "1px solid var(--card-border)", borderRadius: 12, color: "var(--text-primary)", outline: "none"
            }} 
          />
        </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows={3}
                  style={{ width: "100%", padding: 14, background: "var(--bg-secondary)", border: "1px solid var(--card-border)", borderRadius: 12, color: "var(--text-primary)", outline: "none", resize: "none" }} 
                ></textarea>
              </div>
